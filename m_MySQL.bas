...
Public Declare Function mBeep Lib "kernel32" Alias "Beep" (ByVal dwFreq As Long, ByVal dwDuration As Long) As Long
'/****************************************************************************/'
...
Public Const MYSQL_SERVER_VERSION = "4.1.18"
Public Const MYSQL_SERVER_SUFFIX = ""
Public Const FRM_VER = 10
Public Const MYSQL_VERSION_ID = 40118
